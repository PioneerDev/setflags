...
import (
	"net/http"
	_ "set-flags/docs"
	"set-flags/src/middleware/jwt"
	"set-flags/src/pkg/setting"
	v1 "set-flags/src/routers/api/v1"
	"time"
...
func InitRouter() *gin.Engine {
	...
	apiv1.Use(jwt.JWT())
	{
		...
		apiv1.GET("/flags/:id/witnesses", v1.GetWitnessesByPeriod)
		apiv1.GET("/flags/:id/evidences", v1.ListEvidencesWithPeriod)
		apiv1.GET("/myflags", v1.FindFlagsByUserID)
		apiv1.POST("/attachments", v1.UploadEvidence)
		apiv1.GET("/me", v1.Me)
		apiv1.GET("/users/rewards/:flag_id", v1.CheckRewards)
